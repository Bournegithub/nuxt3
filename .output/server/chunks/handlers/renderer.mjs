...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"charset":"UTF-8"},{"name":"description","content":"Nuxt3 site."}],"link":[{"rel":"icon","type":"image/x-icon","href":"favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"UTF-8","viewport":"width=device-width, initial-scale=1.0","title":"Nuxt3 "};
