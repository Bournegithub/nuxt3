...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.fdd98c0f.mjs').then(interopDefault),
  "pages/login/index.vue": () => import('./_nuxt/index-styles.9099ddbb.mjs').then(interopDefault),
